"""
Django base settings for the Quiz Platform project.

Shared settings used by all environments (development, production, etc.).
Environment-specific settings should override values in their own modules.
"""
import os
