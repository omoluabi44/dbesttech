                  ...
                  <tr key={user.id} className="hover:bg-[var(--surface-light)] transition-colors focus-within:bg-[var(--surface-light)]">
                    ...
                    <td className="p-4 text-right">
                      <div className="flex justify-end gap-2">
                        <button onClick={() => setViewUser(user)} className="p-2 text-black hover:text-gray-900 dark:hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded" aria-label={`View details for ${user.username}`} title="View Details">
                        ...
                        {currentUser?.role === 'root_admin' && user.role !== 'admin' && user.role !== 'root_admin' && (
                          <button onClick={() => handleMakeAdmin(user.id)} className="p-2 text-black hover:text-primary-400 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded" aria-label={`Make ${user.username} admin`} title="Promote to Admin">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="add-user-title">
          <div className="bg-[var(--surface)] border border-[var(--surface-dark)] w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center p-6 border-b border-[var(--surface-dark)]">
              ...
              <button onClick={() => setIsAddModalOpen(false)} className="text-black hover:text-gray-900 dark:hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded" aria-label="Close modal">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="view-user-title">
          <div className="bg-[var(--surface)] border border-[var(--surface-dark)] w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center p-6 border-b border-[var(--surface-dark)]">
              ...
              <button onClick={() => setViewUser(null)} className="text-black hover:text-gray-900 dark:hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded" aria-label="Close modal">
                <X size={20} aria-hidden="true" />
              </button>
            </div>
